...
wget "https://github.com/mfontanini/presenterm/releases/download/${VERSION}/presenterm-${VERSION_NUM}-x86_64-unknown-linux-gnu.tar.gz"
tar -xzf "presenterm-${VERSION_NUM}-x86_64-unknown-linux-gnu.tar.gz"
sudo mv "presenterm-${VERSION_NUM}/presenterm" /usr/local/bin/
